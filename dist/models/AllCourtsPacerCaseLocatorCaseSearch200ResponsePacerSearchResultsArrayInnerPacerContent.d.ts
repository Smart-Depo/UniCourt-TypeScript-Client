export declare class AllCourtsPacerCaseLocatorCaseSearch200ResponsePacerSearchResultsArrayInnerPacerContent {
    'object': string;
    'pclCaseLink': string | null;
    'pclJurisdictionType': AllCourtsPacerCaseLocatorCaseSearch200ResponsePacerSearchResultsArrayInnerPacerContentPclJurisdictionTypeEnum | null;
    'pclCaseId': number;
...
export declare enum AllCourtsPacerCaseLocatorCaseSearch200ResponsePacerSearchResultsArrayInnerPacerContentPclJurisdictionTypeEnum {
    Appellate = "Appellate",
