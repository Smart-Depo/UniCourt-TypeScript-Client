...
exports.CaseSearchAPIApiResponseProcessor = exports.CaseSearchAPIApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var CaseSearchAPIApiRequestFactory = (function (_super) {
    __extends(CaseSearchAPIApiRequestFactory, _super);
    function CaseSearchAPIApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CaseSearchAPIApiRequestFactory.prototype.searchCases = function (q, sort, order, pageNumber, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (q === null || q === undefined) {
                            throw new baseapi_1.RequiredError("CaseSearchAPIApi", "searchCases", "q");
                        }
                        localVarPath = '/caseSearch';
                        ...
                        if (sort !== undefined) {
                            requestContext.setQueryParam("sort", ObjectSerializer_1.ObjectSerializer.serialize(sort, "'filedDate' | 'relevancy'", ""));
                        }
                        if (order !== undefined) {
    ...
    CaseSearchAPIApiRequestFactory.prototype.searchCasesById = function (caseSearchId, pageNumber, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (caseSearchId === null || caseSearchId === undefined) {
                            throw new baseapi_1.RequiredError("CaseSearchAPIApi", "searchCasesById", "caseSearchId");
                        }
                        localVarPath = '/caseSearch/{caseSearchId}'
    ...
    return CaseSearchAPIApiRequestFactory;
}(baseapi_1.BaseAPIRequestFactory));
exports.CaseSearchAPIApiRequestFactory = CaseSearchAPIApiRequestFactory;
var CaseSearchAPIApiResponseProcessor = (function () {
    function CaseSearchAPIApiResponseProcessor() {
    }
    CaseSearchAPIApiResponseProcessor.prototype.searchCasesWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CaseSearchAPIApiResponseProcessor.prototype.searchCasesByIdWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return CaseSearchAPIApiResponseProcessor;
}());
exports.CaseSearchAPIApiResponseProcessor = CaseSearchAPIApiResponseProcessor;
//# sourceMappingURL=CaseSearchAPIApi.js.map