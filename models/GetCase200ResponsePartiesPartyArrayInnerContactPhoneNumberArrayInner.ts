...
*/
export class GetCase200ResponsePartiesPartyArrayInnerContactPhoneNumberArrayInner {
    'object': string;
    /**
    * Phone Number
    */
...
export enum GetCase200ResponsePartiesPartyArrayInnerContactPhoneNumberArrayInnerPhoneTypeEnum {
    Default = 'DEFAULT',
    Office = 'OFFICE',
    Fax = 'FAX',
    Phone = 'PHONE'
